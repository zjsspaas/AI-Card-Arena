<template>
  <div id="app">
      ...
      <div class="header-container">
        ...
        <nav class="main-nav">
          ...
          <router-link
            to="/paihang"
            class="nav-item"
            :class="{ active: $route.path === '/paihang' }"
          >
            排行
          </router-link>
          ...
          <router-link
            to="/replay/list"
            class="nav-item"
            :class="{ active: $route.path.includes('/replay') }"
          >
            回放
          </router-link>
          <router-link
    ...
    <!-- 页面背景层（铺满） -->
    <main :class="['page-wrapper', isAuthPage ? 'page-auth' : pageClass]">
      <!-- 内容居中层 -->
